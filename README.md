# Health Impact in Colombia (2024–2025): Key Indicators, Factors and Disease Data
...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18985555.svg)](https://doi.org/10.5281/zenodo.18985555)
...
[![Pages](https://img.shields.io/badge/Live-Microsite-brightgreen)](https://juanmoisesd.github.io/health-impact-in-colombia-20242025-key-indicators-factors-and-disease-data/)

## Overview
Comprehensive dataset of key health indicators for Colombia (2020-2025). Includes mental health metrics (depression, anxiety, suicide rates), healthcare workforce data, infectious disease surveillance (COVID-19, dengue, malaria, HIV), non-communicable disease prevalence (hypertension, diabetes, obesity), and healthcare system indicators. Data disaggregated by year and major regions. Sources: DANE,

## Dataset Status
| Field | Value |
|---|---|
| Status | 🟢 Published |
| DOI | [10.5281/zenodo.18985555](https://doi.org/10.5281/zenodo.18985555) |
| Platform | Zenodo |
| License | CC0 1.0 |
| Published | 2026-03-12 |

## 🌐 Interactive Microsite
**[Open Microsite](https://juanmoisesd.github.io/health-impact-in-colombia-20242025-key-indicators-factors-and-disease-data/)**

## Keywords
Colombia, health indicators, mental health, infectious disease, public health, PAHO, longitudinal dataset

## Citation
> de la Serna Tuya, J.M. (2026). *Health Impact in Colombia (2024–2025): Key Indicators, Facto*. Zenodo. https://doi.org/10.5281/zenodo.18985555
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Comprehensive dataset of key health indicators for Colombia (2020-2025). Includes mental health metrics (depression, anxiety, suicide rates), healthcare workforce data, infectious disease surveillance (COVID-19, dengue, malaria, HIV), non-communicabl* [Dataset]. GitHub. https://github.com/juanmoisesd/health-impact-in-colombia-20242025-key-indicators-factors-and-disease-data

**BibTeX**
```bibtex
@dataset{delaserna2025_health_impact_in_colombia_2024,
